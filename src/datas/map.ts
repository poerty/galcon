...
/*
  ...
  for (let i = 1; i < 4; i++) {
    ...
    towerById[towerId] = {
      ...
      level: 1,
      amount,
      realAmount: amount * parseInt(getEnv('REACT_APP_CALL_RATIO')),
      style: {
    ...
    towers: fromJS({
      ...
      byId: {
        'fcdbb3e1-98d4-478a-b074-85b2e04fbf3a': new Tower({
          ...
          level: 1,
          amount: 5,
          realAmount: 5 * parseInt(getEnv('REACT_APP_CALL_RATIO')),
        ...
        'f8f02d5b-dc90-49d4-b26d-f824bf406bc4': new Tower({
          ...
          level: 5,
          amount: 100,
          realAmount: 100 * parseInt(getEnv('REACT_APP_CALL_RATIO')),
